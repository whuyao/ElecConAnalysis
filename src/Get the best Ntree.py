...
def test_DecisionTreeRegressor_depth(X,y, max_val):
    ...
    depths = [5,10,20,40,60,80,100,200,300,400,500,600,700,800,900,1000]
    #depths = [5,10,20,40,60,400,1000]
    training_scores = []
    testing_scores = []
    for depth in depths:
        print(depth)
        regr = ensemble.RandomForestRegressor( criterion="mse",oob_score=True,n_estimators =depth,max_features=10)
...
y = data[['SJSJ_2']]
'''
test_DecisionTreeRegressor_depth(X,y.values.ravel(), max_val=5)